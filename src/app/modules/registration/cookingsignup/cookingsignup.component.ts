...
@Component({
  selector: 'app-cookingsignup',
  templateUrl: './cookingsignup.component.html',
  styleUrls: ['./cookingsignup.component.scss']
})

export class CookingsignupComponent implements OnInit {
  ...
  types:string[]=['North Indian','South Indian','Mexican','Chinese','Italian','Andhra Style','American','Caribbean','Thai','Spanish','Japanese','Others'];
  ...
  cookingsignup(employee1Form: NgForm): void {
  ...
  cookingsignup1(employee2Form: NgForm): void
        {
          let chefUrl=ApplicationUrls.CHEF_PERSONALINFO;
      ...
      this.restserv.Post(chefUrl,this.em).subscribe(data =>{
